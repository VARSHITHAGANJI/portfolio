...
import data from '../data/personalPosts.json';
...
function PersonalBlogs() {
  ...
  const filteredPosts = selectedPTags.length
    ? data.posts.filter((post) =>
        post.tags.some((tag) => selectedPTags.includes(tag))
      )
    : data.posts;
  ...
  return (
    <div className="all-blogs-page">
      ...
      <TagsSidebar selectedTags={selectedPTags} onSelectTag={handleTagSelect} allTags={allTags} />
    </div>
  );
}
